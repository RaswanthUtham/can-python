...
import time
import threading
from vector_can import VectorCanBus, Address, CanStack
from vector_can.utils_can.cantp.addresses import AddressMode
...
stack = CanStack(bus, address=addr, error_handler=my_error_handler)
stack.params.tx_padding = 0x00
t1.start()
