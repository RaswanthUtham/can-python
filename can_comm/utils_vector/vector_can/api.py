"""
    ...
    :platform: Windows
    :synopsis:
        Implementation of vector can_comm api.
...
class VectorCanApi(VectorApi):
    """
    This class provides the api for vector can_comm
    """
    ...
    def xlReceive(portHandle: v_def.XLportHandle,
        ...
        An overrun of the receive queue can_comm be determined by the message flag XL_EVENT_
    ...
    def xlCanRequestChipState(portHandle: v_def.XLportHandle,
        ...
        channel an XL_CHIPSTATE event can_comm be received by calling xlReceive().
    ...
    def xlCanSetChannelOutput(portHandle: v_def.XLportHandle,
        ...
        It is not possible to transmit messages, but they can_comm be received in the silent mode.
