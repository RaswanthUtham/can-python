"""
    ...
    :file: vector_hw_api.py
    :platform: Windows
    :synopsis:
        Implementation of vector hardware api.
...
"""
# pylint:disable=line-too-long, wildcard-import, invalid-name, unused-wildcard-import, too-many-arguments
from ctypes import *
...
class VectorApi:
    ...
    def xlGetDriverConfig(pDriverConfig: POINTER(v_class.XLdriverConfig)):
        """
        Gets detailed information on the hardware configuration. This function can_comm be called at
    ...
    def xlGetApplConfig(appName: c_char_p,
        ...
        Hardware Configuration tool. The information can_comm then be used to get the required channel mask
        ...
        :param appChannel: Selects the application channel (0,1, …). An application can_comm offer several channels
    ...
    def xlGetSyncTime(portHandle: v_def.XLportHandle, time: POINTER(v_def.XLuint64)):
        ...
        If the XL API function xlResetClock() was not called, the event time stamp can_comm be compared to the time
    ...
    def xlActivateChannel(portHandle: v_def.XLportHandle,
                          ...
                          flags: c_uint):
        """
        Goes ‚on bus’ for the selected port and channels. At this point, the user can_comm transmit
        ...
        :param accessMask: The access mask specifies the channels to be accessed. Typically, the access
                            mask can_comm be directly retrieved from the Vector Hardware Configuration tool if
